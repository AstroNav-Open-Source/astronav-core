...
from catalog_pipeline.identify_stars import identify_stars_from_vectors
...
class TestRotationalAccuracyFromImages(unittest.TestCase):
     ...
     def test_identify_stars_with_image(self):
          ...
          identified_stars = identify_stars_from_vectors(detected_vectors)
     ...
     def test_identify_stars_with_expected_vectors(self):
          ...
          noisy_expected_vectors = add_gaussian_noise_to_vectors(expected_vectors[:len(detected_vectors)], noise_std=0.0001)
