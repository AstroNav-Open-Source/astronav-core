...
from dector import detect
import cv2



def main():
    VideoCap = cv2.VideoCapture('C:/Users/emanu/Videos/Captures/Stellarium 25.2 2025-08-17 15-07-58.mp4')
    #Variable used to control the speed of reading the video
    ControlSpeedVar = 2  #Lowest: 1 - Highest:100
    HiSpeed = 2
